    ...
    >
      <div className="w-full md:w-1/3 text-left">
        ...
        <motion.p
          ...
          className="font-general-medium mt-4 text-xs md:text-sm lg:text-base xl:text-lg text-center sm:text-left leading-normal text-gray-500 dark:text-gray-200"
        >
          Étudiante en MIAGE passionnée par l’analyse de données, je transforme
          les chiffres en décisions concrètes grâce aux outils BI et statistiques
        </motion.p>
        ...
        >
          <a
            download="Warda_resume.pdf"
            href="/files/Warda_resume.pdf"
